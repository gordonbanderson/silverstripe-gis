...
class GDRenderer
{
    ...
    public function drawPoint($coordinates): void
    {
    ...
    public function drawLineString($coordinates): void
    {
    ...
    public function drawPolygon($coordinates): void
    {
    ...
    public function drawMultipoint($multicoordinates): void
    {
    ...
    public function drawMultilinestring($multicoordinates): void
    {
        foreach ($multicoordinates as $coordinates) {
    ...
    public function drawMultipolygon($multicoordinates): void
    {
        foreach ($multicoordinates as $coordinates) {
